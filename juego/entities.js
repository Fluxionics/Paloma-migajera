  ...
  ciudad_alta: [
    {
      ...
      dialogues: [
        'Las migajas del Tejado de los Gansos son las más doradas de la ciudad... pero cuidado, el precio es alto.',
        'Si dominas el Planeo Silencioso, los gatos jamás te oirán caer. El silencio es tu mejor arma.',
        'Al este encontrarás las Alcantarillas... Cuidado con las ratas del alcantarillado. No todas son lo que parecen.',
        'Dicen que el Cuervo de la Chimenea guarda el doble salto. Derrótalo y será tuyo... si estás preparado.',
        'Recuerda: un dash bien Timing puede salvarte de cualquier ataque. Pero el timing también puede ser tu perdición.',
        'Las plataformas de cadena se mueven... espera, no, eso era en otra vida. O quizá sí.',
        'Esta ciudad tiene secretos, pequeña paloma. Algunos mejor quedaron olvidados.',
        'La luna tonight está especialmente brillante. Quizá te esté mostrando el camino... o advirtiéndote.',
      ],
      dIdx: 0,
    },
  ],
  alcantarillas: [
    {
      ...
      dialogues: [
        'Bienvenido a las profundidades... cuidado con los charcos. Lo que reflejan no siempre es verdad.',
        'La Rata Reina es poderosa, pero tiene un punto débil: su arrogancia. Como todos los que gobiernan desde las sombras.',
        'Las migajas aquí son menos valiosas, pero más fáciles de encontrar. Todo tiene su precio.',
        'Si ves una plataforma de metal, ¡no confíes! Se mueve cuando menos lo esperas. El metal nunca descansa.',
        'Este lugar solía ser parte de la ciudad... hasta que "ellos" lo olvidaron. Ahora somos nosotros los olvidados.',
        'Escucha el agua... te cuenta historias de palomas que vinieron antes y nunca salieron.',
      ],
      dIdx: 0,
    },
  ],
  parque_palomas: [
    {
      ...
      dialogues: [
        'Bienvenido al Parque de las Palomas. Aquí los gatos son menos, pero más astutos. La astucia es más peligrosa que la fuerza.',
        'La fuente tiene migajas antiguas... he visto palomas robar pan de aquí toda la vida. Algunas nunca volvieron.',
        'Al este se alza la Torre del Reloj. El Relojero mide cada segundo, y cada trampa. El tiempo es cruel con los pequeños.',
        'Dicen que los que trepan hasta el campanario son tocados por el reloj y aprenden a planear. ¿Te atreves?',
        'Si el cielo se vuelve frío y las estrellas tiemblan... es que la luna te está observando. Y la luna no olvida.',
        'Este parque solía ser hermoso... antes de que la sombra de la ciudad creciera demasiado.',
      ],
      dIdx: 0,
    },
  ],
  torre_reloj: [
    {
      ...
      dialogues: [
        ...
        'Mis engranajes guardan secretos. Sube, sube, ¡pero no tropieces con las cadenas! El tiempo castiga a los imprudentes.',
        'La gran esfera marca las doce y media... para siempre. El reloj también puede caer. Todo lo que sube debe bajar.',
        'Las ratas voladoras adoran el polvo de aquí. Huelen las migajas antes de verlas. El olor del tiempo es inconfundible.',
        'Cuida tus alas: aquí arriba el aire sabe a latón y a madera vieja. Y a recuerdos que preferirías olvidar.',
        '¿Buscas algo? Todos buscan algo aquí. La mayoría solo encuentra eco de sus propios deseos.',
      ],
      dIdx: 0,
    },
  ],
  bosque_encantado: [
    {
      ...
      dialogues: [
        'Shhh... escucha. El bosque respira aquí más profundo que en el parque. Y su aliento cuenta historias.',
        'Los hongos resplandecen porque guardan memoria. Cuánta migaja cae, ellos lo saben. Todo está registrado.',
        'No toques la luna blanca de arriba... o quizá sí, sí puedes. Es solo luz. Pero la luz puede quemar.',
        'Más al este está el Tejado de los Gansos. Lo que allí brilla no es oro, pero sabe a oro. Y a cenizas.',
        'Las ratas voladoras aquí son más viejas. Vuelan en círculos, como si conocieran tu nombre. Quizá te conozcan.',
        'Este bosque existía antes que la ciudad. Recordará cuando la ciudad haya desaparecido.',
      ],
      dIdx: 0,
    },
  ],
  tejado_gansos: [
    {
      ...
      dialogues: [
        '¡Ganso capitán! Bienvenido al último tejado. Aquí vive la leyenda de las migajas doradas. Y las leyendas no mienten... del todo.',
        'Los gatos grandes guardan la antena. Ampárate en los tendederos, no los esquives. La sombra es tu amiga.',
        'Ventisca de plumas: cuando veas rojo en el horizonte, es la ciudad despertándose. Y cuando la ciudad despierta, nosotros dormimos.',
        'Las migajas de valor cinco están escondidas en el aire. Salta dos veces y confía en tus alas. La confianza es más valiosa que el oro.',
        'Has recorrido cada teja de esta ciudad. El cielo te pertenece, pequeña paloma. Pero el cielo también pertenece a la noche.',
        '¿Crees que has terminado? El final es solo el comienzo de algo más grande. Siempre lo es.',
      ],
      dIdx: 0,
    },
  ],
